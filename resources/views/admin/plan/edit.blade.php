...
@method('PUT')
    ...
    <div class="card-body">
      <div class="tab-content" id="custom-tabs-one-tabContent">
        ...
        <div class="row">
            ...
            <div class="col-6 py-2">
                <label for="tipoplan" >Entidad </label>
                ...
                <SELECT   style='width: 100%;
                    ...
                    border-radius:5px;
                    position: relative;
                    font-size: 16px;   color: #6c6c6c;' id='entidad' name='entidad' data-old="{{old('entidad', $plan->entidad_id)}}"> 
    ...
    <div class="card-footer text-center"> 
      ...
      <a href="/admin/plan/{{$plan->id}}/establecimientos/" class='btn btn-secondary '>Administrar Establecimientos</a> 
