...
@section('titulo','Nuevo establecimiento')
...
<div class="card">      
    ...
    <form action="{{ route('admin.establecimiento.store') }}" method='POST'>
      @csrf
        ...
        <div class="col-6 py-2"> 
            ...
            <div class="col-6 py-2">
                ...
                <SELECT   style='width: 100%;
                    ...
                    border-radius:5px;
                    position: relative;
                    font-size: 16px;   color: #6c6c6c;' id='tipoestablecimiento' name='tipoestablecimiento' data-old="{{old('tipoestablecimiento')}}"> 
          ...
          <div class="col-3 py-2">
            <label for="depto" >Piso</label>
                ...
                <input id="piso" type="number " class="form-control @error('piso') is-invalid @enderror" name="piso" value="{{ old('piso') }}" >
    ...
    <div class="card-footer text-center" > 
      ...
      <a  class='btn btn-secondary disabled'>Administrar Prestaciones</a> 
