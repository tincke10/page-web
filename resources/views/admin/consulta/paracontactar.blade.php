...
@section('titulo','Consultas para contactar')
...
@include('custom.modal_eliminar')
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a class='m-2 float-right btn btn-primary' href="/exportar_paracontactar">Exportar a excel</a>
              ...
              <table class="table table-head-fixed text-nowrap">
                  ...
                  @foreach ($consultas as $consulta)
                    ...
                    <tr>
                      <td> {{$consulta->id}}</td>
                      <td> {{substr($consulta->apellido.' '.$consulta->nombres,0,22)}}</td>
